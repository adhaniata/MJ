...
class Akun extends BaseController
{
    ...
    public function profil()
    {
        ...
        return view('admin/akun/profil', $data);
    }
    ...
    public function update_profil(){
        ...
        if (!$this->validate([
            ...
            return redirect()->to(base_url('/admin/akun/profil'))->withInput();
        } else {
            ...
            return redirect()->to(base_url('/admin/akun/profil'));
        }
    }
    ...
    public function update_password(){
        ...
        if (!$this->validate([
            ...
            return redirect()->to(base_url('/admin/akun/password'))->withInput();
        } else {
            $this->userModel->update($user['id'], [
                'password_hash' => Password::hash($pass_konf),
            ]);
            return redirect()->to(base_url('/admin/akun/password'));
        }
    }
}
