...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h3 class="my-3">Form Tambah Data Biaya Ongkir</h3>
            <!--menambahkan action berisi method save untuk menyimpan data-->
            <form action="/admin/ongkir/save" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('kota')) ? 'is-invalid' : ''; ?>" id="kota" name="kota" autofocus value="<?= old('kota'); ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="mb-3">
                            <label for="gambarOngkir" class="form-label">Upload File</label>
                            ...
                            <div class="col-sm-2">
                                <img src="/img/ongkir/jnt.jpg" class="img-thumbnail img-preview">
                            </div>
                        </div>
                    </div>
                </div>
