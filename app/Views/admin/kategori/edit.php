...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h3 class="my-3">Form Edit Data Kategori</h3>
            <!--menambahkan action berisi method update untuk memproses edit-->
            <form action="/admin/kategori/update/<?= $kategori['id_kategori']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('nama_kategori')) ? 'is-invalid' : ''; ?>" id="nama_kategori" name="nama_kategori" autofocus value="<?= (old('nama_kategori')) ? old('nama_kategori') : $kategori['nama_kategori'] ?>">
