    ...
    <div class="row">
        <div class="col">
            <table class="table table-bordered" id="datatable">
                <h2 class="mt-3 mb-4">Daftar Pertanyaan dan Jawaban Chatbot</h2>
                <a href="/admin/chatbot/create" class="btn btn-primary mt-1 mr-1">Tambah</a>
                <br><br>
                ...
                <tbody>
                    <?php foreach ($chatbot as $key => $value) : ?>
                        <tr>
                            <th scope="row"><?= $i++; ?></th>
                            <td><?= $value['id_chatbot']; ?></td>
                            <td><?= $value['pertanyaan']; ?></td>
                            <td><?= $value['jawaban']; ?></td>
                            <td><a href="/admin/chatbot/edit/<?= $value['id_chatbot']; ?>" class="btn btn-warning mb-2">Edit</a>
                                <form action="/admin/chatbot/delete/<?= $value['id_chatbot']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
                                    <!--agar lebih aman-->
