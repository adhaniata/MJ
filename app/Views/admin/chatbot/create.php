...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h3 class="my-3">Form Tambah Data Chatbot</h3>
            <!--menambahkan action berisi method save untuk menyimpan data-->
            <form action="/admin/chatbot/save" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="Masukan Kata Kunci" class="form-control <?= ($validation->hasError('pertanyaan')) ? 'is-invalid' : ''; ?>" id="pertanyaan" name="pertanyaan" autofocus value="<?= old('pertanyaan'); ?>">
                ...
                <div class="row mb-3">
                    <label for="kota" class="col-sm-2 col-form-label">Jawaban</label>
                    <div class="col-sm-10">
                        <textarea class="form-control <?= ($validation->hasError('jawaban')) ? 'is-invalid' : ''; ?>" id="jawaban" name="jawaban" autofocus value="<?= old('jawaban'); ?>"></textarea>
                        <div class="invalid-feedback">
