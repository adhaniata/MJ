        ...
        <div class="col">
            ...
            <?php foreach ($transaksi_detail as $td) : ?>
                <div class="card">
                    ...
                    <?php foreach ($cek_ulasan as $cu): ?>
                        <?php if ($td['id_produkFK'] == $cu['id_produkFk']): ?>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <div class="col-md-8">
                                                <textarea name="isi_ulasan" placeholder="Berikan ulasan anda" class="form-control <?= ($validation->hasError('isi_ulasan')) ? 'is-invalid' : ''; ?>" readonly><?= $cu['isi_ulasan'] ?></textarea>
