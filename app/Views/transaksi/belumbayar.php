...
<div class="card">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/transaksi/belum-bayar">Belum Dibayar</a>
            </li>
            <li class="nav-item">
    ...
    <div class="card-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="mt-3">Transaksi Belum Dibayar</h2>
                            ...
                            <?php foreach ($transaksi as $t) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/transaksi/batal/<?= $t['id_transaksi'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin?');">Batalkan</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
