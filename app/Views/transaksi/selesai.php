...
<div class="card">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/transaksi/selesai">Selesai</a>
            </li>
            <li class="nav-item">
    ...
    <div class="card-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="mt-3">Transaksi Selesai</h2>
                        ...
                        <tbody>
                            <?php foreach ($transaksi as $t) : ?>
                                <tr>
                                    ...
                                    <td><?= $t['created_at'] ?></td>
                                    <td>
                                        <a href="/transaksi/detail-selesai/<?= $t['id_transaksi'] ?>" class="btn btn-dark">Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
